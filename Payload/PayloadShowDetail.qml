...
Flickable {
    ...
    property var typeModel: ["无符号整数","单精度浮点","双精度浮点","字符串","枚举","有符号整数","字符","ASCII","UNICODE"]

    property alias combineData: dataArea.text
    property alias datagram: datagramArea.text
    ...
    Column{
        ...
        ColumnLayout {
            ...
            Button {
                ...
                onClicked: {
                    var info = new Object
                    info["serverip"] = leader.getServerIP()
                    info["serverport"] = Number(leader.getServerPort())
